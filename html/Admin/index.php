...
if($_SESSION['ID']){
			...
			}else{header("location:/html/Admin/login.php");	}
?>
<!doctype html>
<html>
<head>
...
<a href="/html/Admin"><img class="logo" src="http://ediz.goldeli.com/GraduationProject/images/goldeliLogo.png" /> </a>
<div class="box1">
    <div class="container" onclick="myFunction(this);myFunction1(this);">
        ...
        <form action="/php/searchAdmin.php"  method="post">
            <input class="searchBar"type="text" placeholder="Ürün Ara" name="search">
            <input class="searchButton" type="image" src="http://ediz.goldeli.com/GraduationProject/images/search1.png" border="0" alt="Submit" />
            
        </form>
        
</div>
<br>
    <?php include ($_SERVER['DOCUMENT_ROOT']."/php/feedUpdate.php");?>
